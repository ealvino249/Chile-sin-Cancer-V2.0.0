        ...
        <div class="row justify-content-center">
            ...
            @if (permissionCheck('dashboard.number_of_student'))
                <div class="col-md-6 col-lg-3">
                    <a href="/admin/student/allStudent" class="d-block">
            ...
            @if (permissionCheck('dashboard.number_of_instructor'))
                <div class="col-md-6 col-lg-3">
                    <a href="/admin/systemsetting/allInstructor" class="d-block">
                        <div class="white-box single-summery">
                            <div class="d-flex justify-content-between">
                                <div>
            ...
            @if (permissionCheck('dashboard.number_of_subject'))
                <div class="col-md-6 col-lg-3">
                    <a href="/admin/course/all/courses" class="d-block">
                        <div class="white-box single-summery">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h3>Cursos</h3>
                                    <p class="mb-0">Número de cursos</p>
                                </div>
            ...
            @if (permissionCheck('dashboard.number_of_enrolled'))
                <div class="col-md-6 col-lg-3">
                    <a href="/admin/enrol-list" class="d-block">
                        <div class="white-box single-summery">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h3>Inscritos</h3>
                                    <p class="mb-0">Número de inscritos</p>
                                </div>
    ...
    <div class="row justify-content-center">
        @if (permissionCheck('userLoginChartByDays'))
            <div class="col-lg-12">
                <div class="white_box chart_box mt_30">
                    <div class="white_box_tittle list_header">
                        <h4>Registro de sesiones iniciadas(Por fecha)</h4>
                    </div>
                    <div class="row  justify-content-center">
                        <div class="col-md-3">
                            <input type="radio" checked
                                   ...
                                   value="7">
                            <label
                                for="userLoginChartByDays7">Últimos 7 días</label>
                        </div>
                        <div class="col-md-3">
                            <input type="radio"
                                   class="common-radio userLoginChartByDays "
                                   ...
                                   value="14">
                            <label
                                for="userLoginChartByDays14">Últimos 14 días</label>
                        </div>
                        ...
                        <div class="col-md-3">
                            <input type="radio"
                                   ...
                                   value="30">
                            <label
                                for="userLoginChartByDays30">Últimos 30 días</label>
                        </div>
                        ...
                        <div class="col-md-3">
                            <input type="radio"
                                   ...
                                   value="custom">
                            <label
                                for="userLoginChartByDaysCustom">Otros</label>
        ...
        @if (permissionCheck('userLoginChartByTime'))
            <div class="col-lg-12">
                <div class="white_box chart_box mt_30">
                    <div class="white_box_tittle list_header">
                        <h4>Duración de sesión de usuario (Por tiempo)</h4>
                    </div>
                    <div class="row  justify-content-center">
                        <div class="col-md-3">
                            <input type="radio" checked
                                   ...
                                   value="7">
                            <label
                                for="userLoginChartByTime7">Últimos 7 días</label>
                        </div>
                        <div class="col-md-3">
                            <input type="radio"
                                   class="common-radio userLoginChartByTime "
                                   ...
                                   value="14">
                            <label
                                for="userLoginChartByTime14">Últimos 14 días</label>
                        </div>
                        ...
                        <div class="col-md-3">
                            <input type="radio"
                                   ...
                                   value="30">
                            <label
                                for="userLoginChartByTime30">Últimos 30 días</label>
                        </div>
                        ...
                        <div class="col-md-3">
                            <input type="radio"
                                   ...
                                   value="custom">
                            <label
                                for="userLoginChartByTimeCustom">Otras</label>
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    var userLoginChartByDaysData = {
                        ...
                        datasets: [
                            {
                                label: '{{__('Intento de inicio de sesión de usuario')}}',
