                ...
                <li class="position-relative">
                    ...
                    <div class="notification_menu">
                        ...
                        <div class="notification_footer">
                            <a href="{{route('myNotification')}}" class="readMore_text theme_btn small_btn2 p-2 m-1 ">Ver más</a>
                            <a href="{{route('NotificationMakeAllRead')}}" class="readMore_text theme_btn small_btn2 p-2 m-1 ">Marcar leidos</a>
                        </div>
                    </div>
                </li>
                <li>
