<div>
    <div class="main_content_iner main_content_padding">
        <div class="container">
            ...
            <div class="row">
    <div class="col-sm-8"><center><img src="public/frontend/infixlmstheme/img/banner_dashboard.png" style="align" class="img_home"/></center></div>
    ...
    <div class="col">
        ...
        <a href="{{courseDetailsUrl($course->id,$course->type,$course->slug)}}"></a>
          <div class="row no-gutters">
            <div class="col-md-4">
              <img src="{{ getCourseImage($course->thumbnail) }}" class="card-img" height="100%">
            </div>
            <div class="col-md-8">
              <div class="card-body">
                <h5 class="card-title">{{@$course->title}}</h5>
                <p class="card-text"> <span>{{$course->totalReview}}/5</span>
